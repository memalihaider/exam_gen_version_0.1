...
export default function PaperPreview() {
  ...
  useEffect(() => {
    ...
    const savedExercises = localStorage.getItem("selectedPhysicsExercises");
    if (savedExercises) {
      try {
 ...
 const filename = `11th-biology-${paperSettings.section || "section"}-${paperSettings.paperNumber || "paperNumber"}-${formattedDate}`
   .replace(/\s+/g, "-")
   .toLowerCase();
