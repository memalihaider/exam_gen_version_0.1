  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      ...
      try {
        ...
        window.location.href = "/generate-paper/11th/quran-translation/preview";
      } catch (error) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-emerald-600 via-green-500 to-lime-500 bg-clip-text text-transparent leading-relaxed">
              ترجمۃ القرآن المجید - جماعت گیارہویں
            </h1>
            ...
            <div className="flex items-center justify-center gap-2 text-xl">
              ...
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/11th" className="text-emerald-600 hover:text-emerald-800 transition-colors">جماعت گیارہویں</Link>
              <span className="text-gray-500">/</span>
                ...
                <div className="divide-y divide-gray-100">
                  {unit.exercises.map((exercise) => (
                    ...
                    >
                      ...
                      />
                      <span className="text-gray-700 group-hover:text-amber-600 transition-colors text-right w-full text-xl font-nastaliq">
                        {exercise}
                      </span>
                    </label>
                  ))}
...
export default QuranTranslation11th;