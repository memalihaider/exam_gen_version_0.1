  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        ...
        window.location.href = "/generate-paper/11th/biology/preview";
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-teal-600 via-teal-500 to-green-500 bg-clip-text text-transparent">
              Biology - First Year
            </h1>
            ...
            <div className="flex items-center justify-center gap-2 text-sm">
              ...
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/11th" className="text-teal-600 hover:text-teal-800 transition-colors">11th Class</Link>
              <span className="text-gray-500">/</span>
                  ...
                  {unit.exercises.map((exercise) => (
                    ...
                    >
                      <input
                        ...
                        className="w-5 h-5 text-teal-600 rounded-lg border-gray-300 focus:ring-teal-500 transition-all ml-3"
                      />
            ...
            <button
              ...
              className={`
                ...
                ${selectedExercises.length > 0
                  ? 'bg-gradient-to-r from-teal-600 via-teal-500 to-green-500 hover:scale-105 hover:shadow-xl'
