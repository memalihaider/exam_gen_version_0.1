...
const ComputerScience12th = () => {
  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        localStorage.setItem("selectedComputerScience12Exercises", JSON.stringify(selectedExercises));
        window.location.href = "/generate-paper/12th/computer-science/preview";
      } catch (error) {
...
export default ComputerScience12th;