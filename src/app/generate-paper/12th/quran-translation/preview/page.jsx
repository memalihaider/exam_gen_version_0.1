...
export default function PaperPreview() {
  ...
  useEffect(() => {
    ...
    const savedExercises = localStorage.getItem("selectedQuranExercises");
    if (savedExercises) {
      try {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      const subject = paperSettings.subject || "Tarjuma Quran"; // Get current subject
      ...
      if (savedSettings) {
        try {
          ...
          setPaperSettings((prev) => ({
            ...prev,
            ...parsedSettings,
            subject: "Quran Translation", // Ensure subject is set to Islamiat
          }));
...
// ... existing code ...
    ...
    const fetchQuestions = async () => {
      try {
        ...
        const params = new URLSearchParams({
          class: "12th",
          subject: "Quran", // Use Islamiat for the fetch
        });
  ...
  const handlePrintClick = () => {
    ...
    const filename = `12th-tarjuma-quran-${paperSettings.section || "section"}-${
  ...
  const handleSavePaper = async () => {
    try {
      ...
      const paperData = {
        ...
        subject: paperSettings.subject || "Tarjuma Quran",
