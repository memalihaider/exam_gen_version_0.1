  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        ...
        localStorage.setItem("selectedPhysics12Exercises", JSON.stringify(selectedExercises));
        
        // Navigate to the preview page
        window.location.href = "/generate-paper/12th/physics/preview";
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-blue-600 via-cyan-500 to-teal-500 bg-clip-text text-transparent">
              Physics - Second Year
            </h1>
            ...
            <div className="flex items-center justify-center gap-2 text-sm">
              ...
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/12th" className="text-blue-600 hover:text-blue-800 transition-colors">12th Class</Link>
              <span className="text-gray-500">/</span>
                  ...
                  {unit.exercises.map((exercise) => (
                    ...
                    >
                      <input
                        ...
                        className="w-5 h-5 text-purple-600 rounded-lg border-gray-300 focus:ring-purple-500 transition-all ml-3"
                      />
            ...
            <button
              ...
              className={`
                ...
                ${selectedExercises.length > 0
                  ? 'bg-gradient-to-r from-purple-600 via-purple-500 to-fuchsia-500 hover:scale-105 hover:shadow-xl'
