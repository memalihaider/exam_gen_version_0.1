  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      ...
      try {
        ...
        localStorage.setItem("selectedUrduLazmi12Exercises", JSON.stringify(selectedExercises));
        
        // Navigate to the preview page
        window.location.href = "/generate-paper/12th/urdu-lazmi/preview";
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-600 mb-6 text-2xl font-nastaliq">مضامین کا انتخاب کریں</p>
            <div className="flex items-center justify-center gap-2 text-xl">
              ...
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/12th" className="text-rose-600 hover:text-rose-800 transition-colors font-nastaliq">بارہویں جماعت</Link>
              <span className="text-gray-500">/</span>
                  ...
                  <label className="flex items-center justify-between cursor-pointer group">
                    <div className="flex-grow text-right">
                      ...
                      <p className="text-lg text-gray-500 mt-1 font-nastaliq">
                        {unit.exercises.length} مضامین دستیاب ہیں
                      </p>
                    </div>
                ...
                <div className="divide-y divide-gray-100">
                  {unit.exercises.map((exercise) => (
                    ...
                    >
                      ...
                      />
                      <span className="text-gray-700 group-hover:text-rose-600 transition-colors text-right flex-grow text-xl font-nastaliq">
                        {exercise}
                      </span>
                    </label>
                  ))}
          ...
          <div className="mt-12 flex flex-col items-center">
            <p className="text-gray-600 mb-4 text-2xl font-nastaliq">
              {selectedExercises.length} مضامین منتخب کیے گئے
            </p>
            <button
            ...
            >
              {isLoading ? (
                <span className="font-nastaliq">لوڈ ہو رہا ہے...</span>
              ) : (
                <>
                  <span className="font-nastaliq">پرچہ تیار کریں</span>
