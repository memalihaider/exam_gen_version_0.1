  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      ...
      try {
        ...
        localStorage.setItem("selectedPakStudies12Exercises", JSON.stringify(selectedExercises));
        
        // Navigate to the preview page
        window.location.href = "/generate-paper/12th/pakistan-studies/preview";
      } catch (error) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            ...
            <div className="flex items-center justify-center gap-2 text-xl">
              ...
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/12th" className="text-emerald-600 hover:text-emerald-800 transition-colors">12th Class</Link>
              <span className="text-gray-500">/</span>
...
export default PakistanStudies12th;