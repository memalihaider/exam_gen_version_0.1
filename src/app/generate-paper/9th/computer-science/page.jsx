  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        ...
        window.location.href = "/generate-paper/9th/computer-science/preview";
      } catch (error) {
            ...
            <button
              ...
              className={`
                ...
                ${selectedExercises.length > 0
                  ? 'bg-gradient-to-r from-blue-600 via-indigo-500 to-purple-500 hover:scale-105 hover:shadow-xl'
...
export default ComputerScienceNinth
