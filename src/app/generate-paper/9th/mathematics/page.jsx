...
import { mathematicsUnits } from './unitsData';
import { ProtectedRoute } from "@/components/ProtectedRoute";

const MathematicsNinth = () => {
  ...
  // Add paper generation handler
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        // Store selected exercises in localStorage
        localStorage.setItem("selectedMathematicsExercises", JSON.stringify(selectedExercises));
        
        // Navigate to the preview page
        window.location.href = "/generate-paper/9th/mathematics/preview";
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Select exercises to generate a custom paper</p>
                  ...
                  <label className="flex items-center justify-between cursor-pointer group">
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        {unit.exercises.length} exercises available
                      </p>
                    </div>
          ...
          {/* Units Grid - remains mostly the same */}
          
          {/* Update Generate Button with handler */}
            ...
            <button
              ...
              className={`
                ...
                ${selectedExercises.length > 0
                  ? 'bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 hover:scale-105 hover:shadow-xl'
...
export default MathematicsNinth;
