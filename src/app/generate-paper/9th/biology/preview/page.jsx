...
export default function PaperPreview() {
  ...
  // Add this new useEffect after the existing useEffect hooks to auto-populate current date and day
  useEffect(() => {
    // Auto-populate current date and day
    ...
    // Update paperSettings with current date and day
    setPaperSettings((prev) => ({
      ...prev,
  ...
  const handlePrintClick = () => {
    ...
    const filename = `9th-biology-${paperSettings.section || "section"}-${
