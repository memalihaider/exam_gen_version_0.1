  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        ...
        window.location.href = "/generate-paper/9th/physics/preview";
      } catch (error) {
          ...
          <button
            ...
            className={`
              ...
              ${selectedExercises.length > 0
                ? 'bg-gradient-to-r from-blue-600 via-cyan-500 to-teal-500 hover:scale-105 hover:shadow-xl'
