...
export default function PaperPreview() {
  ...
  const [sections, setSections] = useState({
    ...
    u_to_e: [
      {
        title: "Translate the following sentences into English.",
        questions: [],
        marks: 8,
        choice: 0,
      },
    ...
    summary: [
      {
        title: "Write a summary of the following.",
        questions: [],
        marks: 5,
        choice: 0,
      },
    ...
    w_sentence: [
      {
        title: "Use the following words/phrases/idioms in your own sentences.",
        questions: [],
        marks: 2,
        choice: 0,
      },
    ...
    letter: [
      {
        title: "Write a letter on the following topic.",
        questions: [],
        marks: 8,
        choice: 1,
      },
    ...
    story: [
      {
        title: "Write a story on the following topic.",
        questions: [],
        marks: 8,
        choice: 1,
      },
    ...
    dialogue: [
      {
        title: "Write a dialogue between the following.",
        questions: [],
        marks: 8,
        choice: 1,
      },
    ...
    comprehense: [
      {
        title: "Read the following passage carefully and answer the questions given at the end.",
        questions: [],
        marks: 10,
        choice: 0,
      },
    ...
    act_pass: [
      {
        title: "Change the voice of the following sentences.",
        questions: [],
        marks: 1,
        choice: 0,
      },
        ...
        typeSections.forEach((section) => {
          if (section && section.questions && section.questions.length > 0) {
            ...
            if (type === "short" || type === "long") {
              const effectiveCount = Math.max(0, questionsCount - choiceValue)
              marks += effectiveCount * marksPerQuestion
            } else {
...
const getQuestionTextStyle = (type, text) => {
  ...
  if (type === "u_to_e" || isUrduText) {
    return {
      fontFamily: `${nastaliq.style.fontFamily}, sans-serif`,
      fontSize: `${paperSettings.textFontSize}px`, // Use paper settings for consistency
      direction: 'rtl',
      lineHeight: '2.5', // Increased line height for better readability
      textAlign: 'right'
    };
  }
  ...
  return {
    ...baseStyle,
    lineHeight: type === "mcqs" ? paperSettings.lineHeight : 
               type === "short" ? paperSettings.shortQuestionLineHeight :
               type === "long" ? paperSettings.longQuestionLineHeight : 1.5
  };
};
  ...
  setSections((prevSections) => {
    ...
    Object.entries(questionsByType).forEach(([type, questions]) => {
      ...
      if (type === "short") {
        ...
        choiceValue = Math.min(paperSettings.longChoice || 0, questions.length - 1)
      }

      const requiredQuestions = Math.max(1, questions.length - choiceValue)
      
      const title = getHeadingTextByType(type, { questions })
...
const handlePrintClick = () => {
  ...
  const filename = `9th-English-${paperSettings.section || "section"}-${
...
const getHeadingTextByType = (type, section) => {
  ...
  switch (type) {
    ...
    case "long":
      ...
      return `ATTEMPT ALL ${totalQuestions} QUESTIONS.`
    case "e_to_u":
      return "Translate the following paragraph into Urdu."
    case "u_to_e":
      return "Translate the following sentences into English."
    case "summary":
      return "Write a summary of the following."
    case "w_sentence":
      return "Use the following words/phrases/idioms in your own sentences."
    case "letter":
      return "Write a letter on the following topic."
    case "story":
      return "Write a story on the following topic."
    case "dialogue":
      return "Write a dialogue between the following."
    case "comprehense":
      return "Read the passage carefully and answer the questions given at the end."
    case "act_pass":
      return "Change the voice of the following sentences."
    case "direct_indirect":
      return "Change the following sentences into indirect form."
    case "pair_of_words":
      return "Use the following pair of words in your own sentences."
    case "essay":
      return "Write an essay on any one of the following topics."
    case "explanation_poem":
      return "Translate the following lines with reference to the context."
    case "punctuation":
      return "Punctuate the following extract."
    case "application":
      return "Write an application to the following."
    case "idioms_phrasal":
      return "Use the following Idioms/Phrasal verbs in your own sentences."
    default:
      return ""
  }
}
...
const calculateMarksForQuestionType = (questions, type, sectionChoice = 0) => {
  ...
  if (type === "short" || type === "long") {
    const questionsToAttempt = Math.max(0, sectionChoice > 0 ? totalQuestions - sectionChoice : totalQuestions)
                  ...
                  <div className="grid grid-cols-12 gap-3">
                    ...
                    <div className="col-span-3">
                      ...
                      >
                        ...
                        <option value="w_sentence">Words/Sentences</option>
                        ...
                        <option value="comprehense">comprehense</option>
                        <option value="act_pass">Active/Passive Voice</option>
                        <option value="direct_indirect">Direct/Indirect Speech</option>
                        <option value="pair_of_words">Pair of Words</option>
                        <option value="essay">Essay Writing</option>
                        <option value="explanation_poem">Poem Explanation</option>
                        <option value="punctuation">Punctuation</option>
                        <option value="application">Application Writing</option>
                        <option value="idioms_phrasal">Idioms/Phrasal Verbs</option>
                      </select>
                    </div>
