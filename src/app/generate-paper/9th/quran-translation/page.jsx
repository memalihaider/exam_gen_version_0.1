  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      ...
      try {
        ...
        window.location.href = "/generate-paper/9th/quran-translation/preview";
      } catch (error) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            ...
            <div className="flex items-center justify-center gap-2 text-xl">
              ...
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/9th" className="text-emerald-600 hover:text-emerald-800 transition-colors">جماعت نہم</Link>
              <span className="text-gray-500">/</span>
              <span className="text-gray-500">ترجمۃ القرآن</span>
            </div>
          </div>
