  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      ...
      try {
        ...
        localStorage.setItem("selectedUrduLazmi10Exercises", JSON.stringify(selectedExercises));
        
        // Navigate to the preview page
        window.location.href = "/generate-paper/10th/urdu-lazmi/preview";
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4 font-nastaliq" dir="rtl">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-amber-600 via-yellow-500 to-orange-500 bg-clip-text text-transparent leading-relaxed">
              اردو لازمی - جماعت دہم
            </h1>
            <p className="text-gray-600 mb-6 text-2xl">پرچہ تیار کرنے کے لیے عنوانات منتخب کریں</p>
            <div className="flex items-center justify-center gap-2 text-xl">
              <Link href="/" className="text-amber-600 hover:text-amber-800 transition-colors">ہوم</Link>
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper" className="text-amber-600 hover:text-amber-800 transition-colors">پرچہ جات</Link>
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/10th" className="text-amber-600 hover:text-amber-800 transition-colors">جماعت دہم</Link>
              <span className="text-gray-500">/</span>
              <span className="text-gray-500">اردو لازمی</span>
            </div>
          </div>
              ...
              >
                ...
                <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-amber-50 to-orange-50">
                  <label className="flex items-center justify-between cursor-pointer group">
                    <div>
                      <h3 className="text-2xl font-semibold text-gray-800 group-hover:text-amber-600 transition-colors leading-relaxed">
                        {unit.title}
                      </h3>
                ...
                <div className="divide-y divide-gray-100">
                  {unit.exercises.map((exercise) => (
                    ...
                    >
                      ...
                      />
                      <span className="text-gray-700 group-hover:text-amber-600 transition-colors text-xl leading-relaxed">
                        {exercise}
                      </span>
                    </label>
                  ))}
            ...
            <button
              ...
              className={`
                ...
                ${selectedExercises.length > 0
                  ? 'bg-gradient-to-r from-amber-600 via-yellow-500 to-orange-500 hover:scale-105 hover:shadow-xl'
