  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        ...
        window.location.href = "/generate-paper/10th/biology/preview";
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-teal-600 via-emerald-500 to-green-500 bg-clip-text text-transparent">
              Biology - Class 10th
            </h1>
            ...
            <div className="flex items-center justify-center gap-2 text-sm">
              ...
              <Link href="/generate-paper" className="text-teal-600 hover:text-teal-800 transition-colors">Generate Paper</Link>
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/10th" className="text-teal-600 hover:text-teal-800 transition-colors">Class 10th</Link>
              <span className="text-gray-500">/</span>
          ...
          <div className="mb-8 max-w-md mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all"
              />
              ...
              >
                  ...
                  <label className="flex items-center justify-between cursor-pointer group">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="w-6 h-6 text-teal-600 rounded-lg border-gray-300 focus:ring-teal-500 transition-all"
                      />
                    </div>
                  </label>
                </div>
                ...
                <div className="divide-y divide-gray-100">
                  {unit.exercises.map((exercise) => (
                    <label
                      key={exercise}
                      className="flex items-center space-x-3 cursor-pointer group hover:bg-teal-50 px-6 py-3 transition-all"
                    >
                      <input
                        type="checkbox"
                        checked={selectedExercises.includes(exercise)}
                        onChange={() => handleExerciseCheckboxChange(exercise)}
                        className="w-5 h-5 text-teal-600 rounded-lg border-gray-300 focus:ring-teal-500 transition-all"
                      />
            ...
            <button
              ...
              className={`
                ...
                ${selectedExercises.length > 0
                  ? 'bg-gradient-to-r from-teal-600 via-emerald-500 to-green-500 hover:scale-105 hover:shadow-xl'
