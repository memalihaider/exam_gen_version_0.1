...
export default function PaperPreview() {
  ...
  useEffect(() => {
    ...
    const savedExercises = localStorage.getItem("selectedPakStudiesExercises");
    if (savedExercises) {
      try {
...
// ... existing code ...
  ...
  const handlePrintClick = () => {
    ...
    const filename = `10th-Pakistan-Studies-${paperSettings.section || "section"}-${
