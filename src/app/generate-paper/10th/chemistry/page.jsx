  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        ...
        localStorage.setItem("selectedChemistry10Exercises", JSON.stringify(selectedExercises));
        
        // Navigate to the preview page
        window.location.href = "/generate-paper/10th/chemistry/preview";
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-pink-600 via-rose-500 to-red-500 bg-clip-text text-transparent">
            ...
            <div className="flex items-center justify-center gap-2 text-sm">
              ...
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/10th" className="text-pink-600 hover:text-pink-800 transition-colors">Class 10th</Link>
              <span className="text-gray-500">/</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {chemistryUnits
              ...
              >
                {/* Unit Header */}
                <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-pink-50 to-red-50">
                  ...
                  {unit.exercises.map((exercise) => (
                    ...
                    >
                      <input
                        ...
                        className="w-5 h-5 text-pink-600 rounded-lg border-gray-300 focus:ring-pink-500 transition-all"
                      />
            ...
            <button
              ...
              className={`
                ...
                ${selectedExercises.length > 0
                  ? 'bg-gradient-to-r from-pink-600 via-rose-500 to-red-500 hover:scale-105 hover:shadow-xl'
