...
export default function PaperPreview() {
  ...
  const [sections, setSections] = useState({
    ...
    short: [
      {
        title: "Write short answers to the following questions.",
        questions: [],
        marks: 2,
        choice: 5,
      },
    ...
    summary: [
      {
        title: "Write a summary of the poem",
        questions: [],
        marks: 5,
        choice: 0,
      },
    ...
    dir_ind: [
      {
        title: "Change the following sentences into indirect form.",
        questions: [],
        marks: 1,
        choice: 0,
      },
    ...
    pair_o_w: [
      {
        title: "Use the following pair of words in your own sentences.",
        questions: [],
        marks: 1,
        choice: 0,
      },
  ...
  useEffect(() => {
    setSections(prevSections => {
      ...
      const choiceTypes = [
        'short', 'essay', 'e_to_u', 'u_to_e', 
        'summary', 'dir_ind', 'pair_o_w'
      ];
    ...
    paperSettings.summaryChoice,
    paperSettings.dir_indChoice,
    paperSettings.pair_o_wChoice
  ]);
  ...
  const getMarksPerQuestion = (type) => {
    switch (type) {
      case "mcqs": return 1;
      case "short": return 2;
      case "e_to_u": return 8;
      case "u_to_e": return 8;
      case "summary": return 5;
      case "essay": return 15;
      case "dir_ind": return 1;
      case "pair_o_w": return 1;
      default: return 0;
    }
  };
  ...
  const preserveLineBreaks = (text, type) => {
    ...
    switch (type) {
      ...
      case "essay":
        ...
        break;
      case "dir_ind":
        lineHeight = paperSettings.dir_indLineHeight;
        break;
      case "pair_o_w":
        lineHeight = paperSettings.pair_o_wLineHeight;
        break;
      default:
      ...
      Object.entries(questionsByType).forEach(([type, questions]) => {
        ...
        switch (type) {
          ...
          case "summary":
            ...
            break;
          case "dir_ind":
            choiceValue = Math.min(paperSettings.dir_indChoice || 0, questions.length - 1);
            break;
          case "pair_o_w":
            choiceValue = Math.min(paperSettings.pair_o_wChoice || 0, questions.length - 1);
            break;
          default:
            choiceValue = 0;
        }
        ...
        switch (type) {
          ...
          case "short":
            title = choiceValue > 0
              ? `Answer any ${requiredQuestions} of the following ${questions.length} questions.`
          ...
          case "u_to_e":
            ...
            break;
          case "summary":
            title = "Write a summary of the following poem.";
            break;
          case "essay":
            title = choiceValue > 0
  ...
  const handlePrintClick = () => {
    ...
    const filename = `10th-English-${paperSettings.section || "section"}-${paperSettings.paperNumber || "paperNumber"}-${formattedDate}`
      .replace(/\s+/g, "-")
      .toLowerCase();
...
`);
  ...
  const groupQuestionsByType = (questions) => {
    ...
    const grouped = questions.reduce(
      ...
      { mcqs: [], short: [], essay: [], e_to_u: [], u_to_e: [], summary: [], dir_ind: [], pair_o_w: [] }
    );
...
const getHeadingTextByType = (type, section) => {
  ...
  const choiceTexts = {
    mcqs: `Multiple Choice Questions (${totalQuestions}×1=${totalQuestions})`,
    short: choiceValue > 0 
      ? `Answer any ${requiredQuestions} of ${totalQuestions} (${requiredQuestions}×${marksPerQuestion}=${totalMarks})`
      : `Short Answers (${totalQuestions}×${marksPerQuestion}=${totalMarks})`,
    e_to_u: `English to Urdu (${requiredQuestions}×${marksPerQuestion}=${totalMarks})`,
    u_to_e: `Urdu to English (${requiredQuestions}×${marksPerQuestion}=${totalMarks})`,
    summary: choiceValue > 0
      ? `Summary (Choose ${requiredQuestions} of ${totalQuestions}) (${requiredQuestions}×${marksPerQuestion}=${totalMarks})`
      : `Summary (${requiredQuestions}×${marksPerQuestion}=${totalMarks})`,
    essay: choiceValue > 0
      ? `Essay (Choose ${requiredQuestions} of ${totalQuestions}) (${requiredQuestions}×${marksPerQuestion}=${totalMarks})`
      : `Essay (${requiredQuestions}×${marksPerQuestion}=${totalMarks})`,
    dir_ind: `Direct/Indirect (${requiredQuestions}×${marksPerQuestion}=${totalMarks})`,
    pair_o_w: `Pair of Words (${requiredQuestions}×${marksPerQuestion}=${totalMarks})`
  };
  ...
  const calculateMarksForQuestionType = (questions, type) => {
    ...
    switch (type) {
      case "short":
        choice = Math.min(paperSettings.shortChoice || 0, totalQuestions - 1);
        break;
      case "essay":
      ...
      case "u_to_e":
        ...
        break;
      case "summary":
        choice = Math.min(paperSettings.summaryChoice || 0, totalQuestions - 1);
        break;
      case "dir_ind":
        choice = Math.min(paperSettings.dir_indChoice || 0, totalQuestions - 1);
        break;
      case "pair_o_w":
        choice = Math.min(paperSettings.pair_o_wChoice || 0, totalQuestions - 1);
        break;
      default:
  ...
  const calculateTotalMarks = () => {
    ...
    const questionTypes = ["mcqs", "short", "essay", "e_to_u", "u_to_e", "summary", "dir_ind", "pair_o_w"];
            ...
            <div className="bg-white rounded-xl w-[98%] max-w-[1920px] shadow-2xl border border-violet-100">
              ...
              <div className="bg-gradient-to-r from-violet-600 to-indigo-500 text-white px-4 py-2.5 flex justify-between items-center rounded-t-xl">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-base bg-white/20 px-3 py-0.5 rounded-full">10th - English</span>
                </div>
                <div className="flex items-center gap-3">
                  <button
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    <div className="flex items-center gap-3">
                      ...
                      >
                        ...
                        <option value="dir_ind">Direct/Indirect Speech</option>
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setPaperSettings((prev) => ({ ...prev, summaryChoice: Number.parseInt(e.target.value) || 0 }))
                          }
                          className="w-full border border-violet-100 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-4 gap-4 mt-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          type="number"
                          min="0"
                          value={paperSettings.dir_indChoice || 0}
                          onChange={(e) =>
                            setPaperSettings((prev) => ({ ...prev, dir_indChoice: Number.parseInt(e.target.value) || 0 }))
                          }
                          className="w-full border border-violet-100 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30"
                        />
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          type="number"
                          min="0"
                          value={paperSettings.pair_o_wChoice || 0}
                          onChange={(e) =>
                            setPaperSettings((prev) => ({ ...prev, pair_o_wChoice: Number.parseInt(e.target.value) || 0 }))
                          }
                          className="w-full border border-violet-100 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30"
                        />
                      </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="mt-6 space-y-4 border-t border-gray-200 pt-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-xs text-gray-600 mb-1">Summary Line Height</label>
                        <input
                          type="number"
                          step="0.1"
                          value={paperSettings.summaryLineHeight}
                          onChange={(e) =>
                            setPaperSettings((prev) => ({
                              ...prev,
                      ...
                      <div>
                        <label className="block text-xs text-gray-600 mb-1">Direct/Indirect Line Height</label>
                        <input
                          type="number"
                          step="0.1"
                          value={paperSettings.dir_indLineHeight}
                          onChange={(e) =>
                            setPaperSettings((prev) => ({
                              ...prev,
                      ...
                      <div>
                        <label className="block text-xs text-gray-600 mb-1">Pair of Words Line Height</label>
                        <input
                          type="number"
                          step="0.1"
                          value={paperSettings.pair_o_wLineHeight}
                          onChange={(e) =>
                            setPaperSettings((prev) => ({
                              ...prev,
