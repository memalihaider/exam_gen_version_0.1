...
import { mathUnits } from './unitsData';
import { ProtectedRoute } from "@/components/ProtectedRoute";

const Mathematics10th = () => {
  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        ...
        window.location.href = "/generate-paper/10th/mathematics/preview";
      } catch (error) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            ...
            <div className="flex items-center justify-center gap-2 text-sm">
              ...
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/10th" className="text-blue-600 hover:text-blue-800 transition-colors">Class 10th</Link>
              <span className="text-gray-500">/</span>
...
export default Mathematics10th;
