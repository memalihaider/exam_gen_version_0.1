...
import { physicsUnits } from './unitsData';
  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        ...
        localStorage.setItem("selectedPhysicsExercises", JSON.stringify(selectedExercises));
        
        // Navigate to the preview page
        window.location.href = "/generate-paper/10th/physics/preview";
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-purple-600 via-violet-500 to-fuchsia-500 bg-clip-text text-transparent">
              Physics - Class 10th
            </h1>
            ...
            <div className="flex items-center justify-center gap-2 text-sm">
              ...
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/10th" className="text-purple-600 hover:text-purple-800 transition-colors">Class 10th</Link>
              <span className="text-gray-500">/</span>
              ...
              >
                  ...
                  <label className="flex items-center justify-between cursor-pointer group">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="w-6 h-6 text-purple-600 rounded-lg border-gray-300 focus:ring-purple-500 transition-all"
                      />
                    </div>
                  </label>
                </div>
                ...
                <div className="divide-y divide-gray-100">
                  {unit.exercises.map((exercise) => (
                    <label
                      key={exercise}
                      className="flex items-center space-x-3 cursor-pointer group hover:bg-purple-50 px-6 py-3 transition-all"
                    >
                      <input
                        type="checkbox"
                        checked={selectedExercises.includes(exercise)}
                        onChange={() => handleExerciseCheckboxChange(exercise)}
                        className="w-5 h-5 text-purple-600 rounded-lg border-gray-300 focus:ring-purple-500 transition-all"
                      />
            ...
            <button
              ...
              className={`
                ...
                ${selectedExercises.length > 0
                  ? 'bg-gradient-to-r from-purple-600 via-violet-500 to-fuchsia-500 hover:scale-105 hover:shadow-xl'
