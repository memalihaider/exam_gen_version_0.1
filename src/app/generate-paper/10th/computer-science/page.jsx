  ...
  const handleGeneratePaper = async () => {
    if (selectedExercises.length > 0) {
      try {
        ...
        localStorage.setItem("selectedComputerScience10Exercises", JSON.stringify(selectedExercises));
        
        // Navigate to the preview page
        window.location.href = "/generate-paper/10th/computer-science/preview";
      } catch (error) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 text-center">
            <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-indigo-600 via-purple-500 to-violet-500 bg-clip-text text-transparent">
            ...
            <div className="flex items-center justify-center gap-2 text-sm">
              ...
              <span className="text-gray-500">/</span>
              <Link href="/generate-paper/10th" className="text-indigo-600 hover:text-indigo-800 transition-colors">Class 10th</Link>
              <span className="text-gray-500">/</span>
            ...
            <button
              ...
              className={`
                ...
                ${selectedExercises.length > 0
                  ? 'bg-gradient-to-r from-indigo-600 via-purple-500 to-violet-500 hover:scale-105 hover:shadow-xl'
...
export default ComputerScience10th;